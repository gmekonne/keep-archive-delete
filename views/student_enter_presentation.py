...
# =====================================================================
# FIXED: SECURE CACHED HOSTINGER MYSQL CONFIGURATION ENGINE
# =====================================================================
@st.cache_resource(ttl=300)  # Caches the connection resource for 5 minutes to prevent Hostinger socket drops
def get_cached_mysql_connection():
    """Establishes a resilient connection pipe anchored to your Hostinger server."""
    return pymysql.connect(
        ...
        autocommit=True  # Forces immediate table sync to clear connection loops fast
    )
...
# 1. Verification Phase: Student input
...
if st.button("Fetch My Group & Course Details", width="stretch"):
    try:
        # Pull from our optimized background connection cache
...
# 2. Workspace Phase: Triggers after validation check
